...
const manifest={contractVersion:'1.0.0',schemaSha256:hash(join(root,'proto/collector/v1/collector.proto')),sourceSha,tools:{protoc:'33.0','protoc-gen-go':'1.36.10','protoc-gen-go-grpc':'1.6.2','upstream-protoc-gen-go':'1.36.12','upstream-protoc-gen-go-grpc':'1.6.2','protoc-gen-es':'2.10.1',typescript:'5.9.3'},bundleSha256:Object.fromEntries(files.map(p=>[relative(root,p).replaceAll('\\','/'),hash(p)]))};
