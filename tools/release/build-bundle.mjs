...
const roles=['postgres','redis','discover','coordinator','worker','query','cookie-auth']; const images=Object.fromEntries(roles.map(k=>[k,process.env[`IMAGE_${k.toUpperCase().replaceAll("-","_")}`]]));
